/*var musiclist = {
    ...
    // musiclist.data[0].name = obj.name;
    // musiclist.data[0].albumArtistName = obj.albumArtistName;
    // musiclist.data[0].duration = obj.duration;
    // musiclist.data[0].coverUrl = obj.coverUrl;
    // musiclist.data[0].url = obj.url;
